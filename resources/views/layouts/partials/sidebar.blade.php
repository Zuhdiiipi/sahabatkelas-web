...
>
    ...
    <div class="flex-1 overflow-y-auto py-6 px-4 space-y-1 scrollbar-thin scrollbar-thumb-teal-600">
        ...
        @elseif ($user->role === 'siswa')
            ...
            <a href="{{ route('siswa.report.create') }}" title="Lapor Masalah (Safe Report)" class="sidebar-menu-item group flex items-center px-3 py-2.5 text-sm rounded-r-xl rounded-l-sm transition-all {{ request()->routeIs('siswa.report.*') ? $kelasAktif : $kelasTidakAktif }}">
                ...
                <span class="sidebar-text transition-opacity duration-300 whitespace-nowrap">Lapor Masalah (Safe Report)</span>
            </a>
        @endif
